...
Rolled log files are named with a date suffix: server_20260315.log
"""
...
class _DailyFileHandler(TimedRotatingFileHandler):
    """Daily rotating file handler that produces server_YYYYMMDD.log suffixes.
    ...
    base filename. This subclass overrides namer to produce:
      server_20260315.log  (instead of server.log.2026-03-15)
    """
    ...
    def _namer(self, default_name: str) -> str:
        """Rename rolled file from server.log.20260315 to server_20260315.log."""
